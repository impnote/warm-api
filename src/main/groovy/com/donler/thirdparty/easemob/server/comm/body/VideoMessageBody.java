...
import com.donler.thirdparty.easemob.server.comm.constant.MsgType;
...
public class VideoMessageBody extends MessageBody {
	...
	public Boolean validate() {
		return super.validate() && StringUtils.isNotBlank(url) && StringUtils.isNotBlank(filename) && StringUtils.isNotBlank(secret) && null != length && null != fileLength && StringUtils.isNotBlank(thumb) && StringUtils.isNotBlank(thumbSecret);
	}
}
